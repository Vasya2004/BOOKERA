...
export function BookForm({ book, action }: BookFormProps) {
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              JPG, PNG или WebP до 5 МБ. Файл заменит URL выше.
            </p>
          </div>
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Textarea
              ...
              placeholder="Коротко о книге, контексте и зачем вы её читаете"
            />
          </div>
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Textarea
              ...
              placeholder="Главная мысль, к которой стоит вернуться"
            />
          </div>
        </div>
